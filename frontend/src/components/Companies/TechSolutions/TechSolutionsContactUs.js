...
import style from "./TechSolutionsContactUs.module.css";
...
const TechSolutionsContactUs = () => {
  const navigate = useNavigate();

  return (
    <div className={style.pageWrapper}>
      {/* Skewed Header Navigation Bar */}
      <TechSolutionsHeader activeTab="contact" />
...
export default TechSolutionsContactUs;
