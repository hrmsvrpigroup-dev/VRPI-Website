...
import style from "./ManagementConsultingHeader.module.css";
...
const ManagementConsultingHeader = ({ activeTab }) => {
        ...
        <div className={style.skewedNavContainer}>
          <nav className={style.navLinks}>
            <span
              ...
              onClick={() => navigate("/management-consulting")}
            >
              Home
            </span>
            <span
              className={`${style.navLink} ${activeTab === "about" ? style.activeLink : ""}`}
              onClick={() => navigate("/management-consulting/about")}
            >
              About Us
            </span>
            <span
              className={`${style.navLink} ${activeTab === "services" ? style.activeLink : ""}`}
              onClick={() => navigate("/management-consulting/services")}
            >
              Services
            </span>
            <span
              className={`${style.navLink} ${activeTab === "contact" ? style.activeLink : ""}`}
              onClick={() => navigate("/management-consulting/contact")}
            >
              Contact Us
            </span>
          </nav>
...
export default ManagementConsultingHeader;
