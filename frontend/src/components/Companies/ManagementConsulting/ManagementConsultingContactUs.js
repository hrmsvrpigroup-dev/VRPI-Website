...
import style from "./ManagementConsultingContactUs.module.css";
...
const ManagementConsultingContactUs = () => {
  const navigate = useNavigate();

  return (
    <div className={style.pageWrapper}>
      {/* Skewed Header Navigation Bar */}
      <ManagementConsultingHeader activeTab="contact" />
...
export default ManagementConsultingContactUs;
