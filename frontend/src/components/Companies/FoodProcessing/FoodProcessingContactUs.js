...
import style from "./FoodProcessingContactUs.module.css";
...
const FoodProcessingContactUs = () => {
  const navigate = useNavigate();

  return (
    <div className={style.pageWrapper}>
      {/* Skewed Header Navigation Bar */}
      <FoodProcessingHeader activeTab="contact" />
...
export default FoodProcessingContactUs;
