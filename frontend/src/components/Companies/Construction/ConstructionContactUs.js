...
import style from "./ConstructionContactUs.module.css";
...
const ConstructionContactUs = () => {
  ...
  return (
    <div className={style.pageWrapper}>
      ...
      <ConstructionHeader activeTab="contact" />
      ...
      <section className={style.formMapSection}>
        ...
        <div className={style.formMapGrid}>
          ...
          <div className={style.formCol}>
            <form className={style.discussForm} onSubmit={(e) => {
              e.preventDefault();
              const formData = {
                name: e.target[0].value,
                email: e.target[1].value,
                phone: e.target[2].value, // Using subject field as phone/subject
              ...
              <input type="text" placeholder="Subject / Phone" required className={style.formInput} />
