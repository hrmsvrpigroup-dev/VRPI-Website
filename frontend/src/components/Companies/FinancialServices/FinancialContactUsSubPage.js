...
import style from "./FinancialContactUsSubPage.module.css";
...
const FinancialContactUsSubPage = () => {
        ...
        <div className={style.headerRight}>
          ...
          <div className={style.skewedNavContainer}>
            <nav className={style.navLinks}>
              ...
              <span className={style.navLink + " " + style.activeLink} onClick={() => navigate("/financial-services/contact")}>
                Contact Us
              </span>
            </nav>
        ...
        <div className={style.formMapGrid}>
          ...
          <div className={style.formCol}>
            <form className={style.discussForm} onSubmit={(e) => e.preventDefault()}>
              ...
              {/* Note: Placeholder spelled 'Your Massage' to match screenshot */}
              <textarea placeholder="Your Massage" required className={style.formTextarea} rows="6"></textarea>
...
export default FinancialContactUsSubPage;
